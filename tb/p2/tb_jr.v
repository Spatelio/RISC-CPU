...
module tb_jr;
    ...
    initial begin
        // jr R12: opcode = 10100, Ra = 12, rest unused
        // Place instruction at address 0x10 -> PC is preloaded to 0x10
        uut.u_ram.memData[9'h010] = {5'b10100, 4'd12, 23'd0};
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T0: begin
                ...
                // FOR JR R12 DEMO: R12 = 0xFF, PC = 0x10
            ...
            // T2: load instr from MDR into IR
            T2: begin
                mdr_out = 1;
                ir_in   = 1;
            end
