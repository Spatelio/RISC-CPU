...
module tb_jr;
    ...
    initial begin
        uut.u_ram.memData[9'h00F] = {5'b10001, 4'd12, 4'd0, 19'h000}; // jr r12 pc has to start at FF
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T0: begin
                ...
                zlo_in     = 1;
                force uut.u_regs.GEN_REGS[12].u_reg.q = 32'h000000FF;
                force uut.u_regs.u_pc.q = 32'h0000000F;
                #1
                release uut.u_regs.u_pc.q; //stored instr at the addr right before what we want pc to be
            end
