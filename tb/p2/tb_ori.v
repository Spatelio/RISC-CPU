...
module tb_ori;
    ...
    initial begin
        uut.u_ram.memData[9'h000] = {5'b10001, 4'd7, 4'd4, 19'h071}; // ori r7 r4 0x71
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T0: begin
                ...
                zlo_in     = 1;
                force uut.u_regs.GEN_REGS[4].u_reg.q = 32'h00000063;
            end
