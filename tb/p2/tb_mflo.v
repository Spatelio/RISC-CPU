...
module tb_mflo;
    ...
    initial begin
        // mflo R1 : opcode = 11001, Ra = 1
        uut.u_ram.memData[9'h010] = {5'b11001, 4'd1, 23'd0};
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T0: begin
                ...
                // preload registers involved for mflo instruction
                // pc starts at 0x10, lo holds the value to move, R1 starts known
                force uut.u_regs.u_pc.q               = 32'h00000010;
                force uut.u_regs.u_lo.q               = 32'h12345678;
                force uut.u_regs.GEN_REGS[1].u_reg.q  = 32'h00000000;
                #1;
                release uut.u_regs.u_pc.q;
                release uut.u_regs.u_lo.q;
                release uut.u_regs.GEN_REGS[1].u_reg.q;
            end
