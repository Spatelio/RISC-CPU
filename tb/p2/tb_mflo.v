...
module tb_mflo;
    ...
    initial begin
        uut.u_ram.memData[9'h000] = {5'b01101, 4'd7, 4'd4, 19'h000}; // mul r7 r4
        uut.u_ram.memData[9'h001] = {5'b10001, 4'd1, 4'd0, 19'h000}; //mflo r1
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // hi_out gra, rin should get lo regs value into r
            A3: begin
                lo_out = 1;
                gra = 1;
                rin = 1;
