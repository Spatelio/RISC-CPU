...
module tb_st_case1;
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            Stop: begin
                ...
                if (uut.u_ram.memData[9'h01F] === 32'h00000063) begin
                    $display("PASSED: Memory at 0x1F correctly contains 0x63"); 
                end else begin
                    $display("FAILED: Memory at 0x1F contains %h (expected 0x63)", uut.u_ram.memData[9'h01F]);
                end
                $finish;
            end
        endcase
    ...
    initial begin
        $dumpfile("waves/p2/st_case1.vcd");
        $dumpvars(0, tb_st_case1);
    end
