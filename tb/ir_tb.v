...
module ir_tb;
    parameter Default = 4'b0000, T0 = 4'b0001, T1 = 4'b0010, T2 = 4'b0011,
              T3 = 4'b0100, T4 = 4'b0101, Stop = 4'b0110;
    ...
    always @(Present_state) begin
        case (Present_state)
            ...
            // Load instruction word into MDR from "memory"
            T1: begin
                mdatain = 32'h112B_0000;
                read = 1; mdr_in = 1;
            end
            ...
            // check IR
            T4: begin
                if (uut.u_regs.ir !== 32'h112B_0000) begin
                    $display("FAIL(IR): expected %h got %h", 32'h112B_0000, uut.u_regs.ir);
                    $stop;
                end else begin
                    $display("PASS(IR): IR loaded correctly = %h", uut.u_regs.ir);
                end
                if (bus_multi) $display("WARNING(IR): bus_multi asserted.");
            end
