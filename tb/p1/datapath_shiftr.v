...
module datapath_shiftr_tb;    
    ...
    initial begin
        $dumpfile("waves/shiftr.vcd"); // Name of the output waveform file
        $dumpvars(0, datapath_shiftr_tb); // 0 dumps all signals in the module and below
    end
