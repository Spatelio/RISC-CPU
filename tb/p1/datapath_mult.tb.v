...
module datapath_mult_tb;    
    ...
    initial begin
        $dumpfile("waves/mult.vcd"); // Name of the output waveform file
        $dumpvars(0, datapath_mult_tb); // 0 dumps all signals in the module and below
    end
