...
module datapath_shiftl_tb;    
    ...
    initial begin
        $dumpfile("waves/shiftl.vcd"); // Name of the output waveform file
        $dumpvars(0, datapath_shiftl_tb); // 0 dumps all signals in the module and below
    end
